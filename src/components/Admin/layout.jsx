      ...
      <nav className="bg-red-700 w-64 flex-shrink-0 flex flex-col justify-between">
        <div className="p-4">
          ...
          <div className="space-y-4">
            ...
            <NavLink to="/admin/listaUsuarios">Usuarios</NavLink>
            <NavLink to="/admin/listaAccesos">Accesos</NavLink>
            <NavLink to="/admin/cursosList">Cursos</NavLink>
            <NavLink to="/admin/revisarsolicitud">Solicitudes de Acceso</NavLink>
